...
import useStyles from './OrderInfo-style';
  ...
  return (
            ...
            <div class="d-flex">
              <div className="flex-shrink-0">
                <img src={"http://34.92.49.138/ecommerce/image/" + orderItem.picture} alt={orderItem.name} width="200" className="ml-lg-5 order-1 order-lg-2" />
